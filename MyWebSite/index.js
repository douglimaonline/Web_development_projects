function changeColor() {
    if (document.firstElementChild.getAttribute("data-bs-theme") === "dark") {
        ...
        document.querySelector("#header #ChangeCollorButton").firstElementChild.setAttribute("class", "form-check-input bg-light")
        ...
        document.querySelector("#header #ChangeCollorButton").firstElementChild.setAttribute("class", "form-check-input bg-dark")
